...
def fill_params(expt_name, chkpt_num, gpus,
    ...
    params["expt_dir"]    = "/jukebox/wang/zahra/conv_net/training/prv/experiment_dirs/{}".format(expt_name)
    ...
    #Dataset params
    params["data_dir"]    = "/jukebox/wang/zahra/conv_net/annotations/prv/201904_human_curated_inputs_ventricles_removed_neocortex_only/otsu"
