...
#loop
paths = [xx for xx in os.listdir(out) if "chck_errs.sh" not in xx and "save" not in xx and "logs" not in xx and "slurm_scripts" not in xx and "output_chnks" not in os.listdir(os.path.join(out, xx))]
paths_to_call = []
for pth in paths:
