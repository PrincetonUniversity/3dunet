...
Script written by Tom Pisano (tpisano@princeton.edu, tjp7rr@gmail.com)
"""
...
from utils.directorydeterminer import directorydeterminer
...
def compress_full_sizedatafld(jobid, cores=None, chunksize=None, compression=1, removeoriginal=False, **kwargs):
    ...
    lst = p.map(compress_full_helper, iterlst); lst.sort()
