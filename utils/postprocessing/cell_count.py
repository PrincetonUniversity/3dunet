...
if __name__ == '__main__':
    ...
    cnn_src = os.path.join(cnn_src, 'cnn_patches') #load predicted patched array 

    #set params
    patchsize = (64,3840,3328) #(64,3840,3136)#tuple(args.patchsz)
    stridesize = (44,3648,3136) #(44,3648,2944) #tuple(args.stridesz)
    verbose = True 
