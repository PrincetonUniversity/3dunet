...
if __name__ == "__main__":
    ...
    dsets = [xx for xx in points_dict.keys()]
    
    #separate annotators - will have to modify conditions accordinaly
    ann1_dsets = [xx for xx in points_dict.keys() if xx[:13] == "JGANNOTATION_"]
    ann2_dsets = [xx for xx in dsets if xx not in ann1_dsets and any(xx in yy for yy in ann1_dsets)]
